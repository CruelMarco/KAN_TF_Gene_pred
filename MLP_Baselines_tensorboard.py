...
# print(device)
log_dir = "/BS/SparseExplainability/nobackup/KANSysbio/codes/models/log_dir"
...
for epoch in range(n_epochs):
    ...
    with tqdm.tqdm(batch_start, unit="batch", mininterval=0, disable=True) as bar:
        ...
        for start in bar:
            ...
            # Logging the batch-wise training loss
            writer.add_scalar('Loss/Train', float(loss), epoch * len(X_cal) // batch_size + start // batch_size)
    ...
    with torch.no_grad():
        ...
        # Logging the epoch-wise validation loss
